...
export class DataUtil {
  ...
  public static ParaData(ent: string): Date {
  ...
  // public static somaHoras(parcela1: string, parcela2: string): string {

  //   let p1 = parcela1.split(":");
  //   let p2 = parcela2.split(":");

  //   let minutosP1 = parseInt(p1[0]) * 60 + parseInt(p1[1]);
  //   let minutosP2 = parseInt(p2[0]) * 60 + parseInt(p2[1]);
  //   return DataUtil.minutosToTimeStr(minutosP1 + minutosP2);
  // }



  // public static paraMinutos(hora: string): number {
  //   let p1 = hora.split(":");
  //   return parseInt(p1[0]) * 60 + parseInt(p1[1]);    
  // }
